...
<p align="center">
  <img width="95%" src="./dist/contribution-graph.svg" alt="Contribution graph" />
</p>
...
<!--
  ...
  slab on a dark README. The contribution graph above is now self-generated by
  scripts/contrib-graph.mjs via the contrib-graph.yml workflow, pulling straight from
  GitHub's GraphQL contributions API on a schedule, so it always matches the profile.
