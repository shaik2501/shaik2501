...
<!--
  ...
  slab on a dark README. No chart is embedded here on purpose: GitHub renders the real
  contribution graph on the profile page directly below this README, and it is always
  correct. Note that it shows 104 to logged-out visitors and a higher number to the
  account owner, because private contributions are only counted for signed-in owners
  unless "Include private contributions on my profile" is enabled.
